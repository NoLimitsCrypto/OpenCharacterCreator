...
const SwitchTrack = styled("span")(({ theme }) => `
  ...
  display: block;
`);
export default function LeftRightSwitch(props) {
    const { isLeft, category, changeSide, updateMesh } = useGlobalState();
    ...
    return (_jsxs(SwitchRoot, { className: clsx(stateClasses), children: [_jsx(SwitchTrack, { children: _jsx(SwitchThumb, { className: clsx(stateClasses) }) }), _jsx(SwitchInput, { ...getInputProps(), "aria-label": "Left/Right Switch" })] }));
}
